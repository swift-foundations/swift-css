...
struct ColorThemeTests {
    ...
    @Test(
        "Gray shades have distinct dark mode variants",
        arguments: [
    ...
    func grayShadesDarkMode(name: String, color: DarkModeColor) {
        #expect(
    ...
    @Test(
        "Blue shades have distinct dark mode variants",
        arguments: [
    ...
    func blueShadesDarkMode(name: String, color: DarkModeColor) {
        #expect(
            color.light != color.dark,
    ...
    @Test(
        "Red shades have distinct dark mode variants",
        arguments: [
    ...
    func redShadesDarkMode(name: String, color: DarkModeColor) {
        #expect(
            color.light != color.dark,
    ...
    @Test(
        "Green shades have distinct dark mode variants",
        arguments: [
    ...
    func greenShadesDarkMode(name: String, color: DarkModeColor) {
        #expect(
            color.light != color.dark,
    ...
    @Test("Card background has distinct dark mode variant")
    func cardBackgroundHasDarkMode() {
...
extension `Snapshot Tests` {
    @Suite("Color Theme Snapshot Tests")
    struct ColorThemeSnapshotTests {
        ...
        @Test("Themed red uses theme color with dark mode")
        func themedRedSnapshot() {
            assertInlineSnapshot(
                of: HTML.Document {
                    div { "Themed Red" }
                        .css.color(.red)
        ...
        @Test("Single color DarkModeColor does not generate dark mode CSS")
        func singleColorNoDarkMode() {
            assertInlineSnapshot(
                of: HTML.Document {
                    div { "Single" }
        ...
        @Test("Transparent does not generate dark mode CSS")
        func transparentNoDarkMode() {
            assertInlineSnapshot(
                of: HTML.Document {
                    div { "Transparent" }
